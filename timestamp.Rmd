...
The solution of this PDE $\small \Rightarrow f(t, N_0, \lambda)$,
- $\small N_0$ - the initial counts of timestamped cells at time 0. 
- $\small \lambda$ - net rate of loss &mdash; varies with cell age.
...
- Age-structured model can explain naive T cell dynamics in diverse settings.
