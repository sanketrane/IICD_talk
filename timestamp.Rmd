...
where, $\small \lambda = \delta - \rho  \quad \rightarrow$ net loss rate $\quad \quad \lambda(a) = \lambda_0 \, exp(-\gamma \, age)$
...
&\lambda \sim \text{Normal}(\mu_{\lambda}, \sigma_{\lambda})   \quad \quad \quad \text{... varying rate of loss between cohorts/animals}
\end{aligned}
$$
]
