...
where, net loss rate $\small \rightarrow \lambda = \delta - \rho  \quad \Rightarrow \quad \quad \lambda(a) = \lambda_0 \, e^{-\gamma \, a}$
...
\\
&N_0 \sim \text{Normal}(\mu_N, \sigma_N)   \quad \quad \text{... varying the intercept between cohorts/animals} \\
&\lambda_0 \sim \text{Normal}(\mu_{\lambda}, \sigma_{\lambda})   \quad \quad \quad \text{... varying rate of loss between cohorts/animals}
\end{aligned}
$$
]
