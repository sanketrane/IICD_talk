...
- Each model was fitted simultaneously to the timecourses of $log(\text{counts})$   proportions of $logit(\text{Ki}67^{high})$ cells.
...
### Models are selected based on **parsimony** and their ability to predict **out-of-sample prediction error.**
...
.shadedbox[
$$
\omega_i = \frac{exp(-\frac{1}{2} \, [\text{Loo-ic}]_i)}{\sum_m^M  \, exp(-\frac{1}{2} \, [\text{Loo-ic}]_m)}
$$
]
---
